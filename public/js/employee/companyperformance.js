    ...
    $("body").on('change', '#time_period', function () {
        ...
        if(time_period != '')
        {
          $.ajax({
              ...
              url: baseurl + "employee/employee-performance-ajaxAction",
              data: {
                      _token: $('#_token').val(),
                      empid: empid, 
      ...
      var emparray = $("#employee").val();
        ...
        var arrList = {
            ...
            'ajaxURL': baseurl + "employee/employee-performance-ajaxAction",
        ...
        $('body').on('click', '.applyBtn', function () {
            ...
            location.href = baseurl + 'employee/employee-performance?' + querystring;
        });
