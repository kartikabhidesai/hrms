       ...
       $('body').on('click', '.deleteTicket', function() {
        ...
        $('body').on('click', '.yes-sure', function() {
            ...
            $.ajax({
                ...
                url: baseurl + "employee/employee-ticket-ajaxAction",
        ...
        var dataArr = {"priority" : priority, "status" : status};
            ...
            'ajaxURL': baseurl + "employee/employee-ticket-ajaxAction",
        ...
        $('body').on('click', '.filler', function () {
            ...
            location.href = baseurl + 'employee/employee-ticket-list?' + querystring;
        });
