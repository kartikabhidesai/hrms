var Task = function () {
    ...
    var handleList = function () {
        ...
        var arrList = {
            'tableID': '#taskTable',
            'ajaxURL': baseurl + "employee/employee-task-ajaxAction",
        ...
        $('body').on('click', '.filler', function () {
            ...
            location.href = baseurl + 'employee/employee-task-list?' + querystring;
        }); 
    }
    ...
    $("body").on('click', '.taskDetails', function () {
        ...
        $.ajax({
            ...
            url: baseurl + "employee/employee-task-ajaxAction",
