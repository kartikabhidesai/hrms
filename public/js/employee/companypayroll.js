    ...
    var handleList = function () {
        ...
        $('body').on('click', '.yes-sure', function() {
            ...
            $.ajax({
                ...
                url: baseurl + "employee/employee-payroll-ajaxAction",
        ...
        $('body').on('change', '#months,#year', function() {
            ...
            if(months != '' && year != '' && empid != '')
            {
                $.ajax({
                    ...
                    url: baseurl + "employee/employee-payroll-check-award",
        ...
        $('body').on('click', '.applyBtn', function () {
            ...
            location.href = baseurl + 'employee/employee-payroll-list?' + querystring;

        });

        $('body').on('click', '.clearBtn', function () {
            location.href = baseurl + 'employee/employee-payroll-list';
        });   
