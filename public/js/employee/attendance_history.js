var AttendanceHistory = function() {
    var handleList = function() {
        ...
        var columnWidth = {"width": "10%", "targets": 0};
            ...
            'ajaxURL': baseurl + "employee/employee-attendance-history-ajaxAction",
     ...
     $('body').on('click', '.getAttedanceHisory', function() {
        ...
        location.href = baseurl + 'employee/employee-manage-attendance-history?' + qureystring;
    });
    $('body').on('click', '.historyDetailsModel', function() {
       var data = $(this).attr('data-id');
        $.ajax({
            ...
            url: baseurl + "employee/employee-attendance-history-ajaxAction",
