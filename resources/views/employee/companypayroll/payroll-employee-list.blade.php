            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a href="{{ route('employee-payroll-add',array('id' => $empId)) }}" class="btn btn-primary dim" ><i class="fa fa-plus"> Add Payroll</i></a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="{{ route('employee-payroll-edit',array('id'=> $val['id'])) }}" class="link-black text-sm" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-edit"></i></a>
