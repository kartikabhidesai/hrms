        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{ asset('frontend/img/team/team1.png') }}" alt="">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{ asset('frontend/img/team/team2.png') }}" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{ asset('frontend/img/team/team3.png') }}" alt="">
              <div class="team-details">
                <div class="team-inner">                  
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{ asset('frontend/img/team/team4.png') }}" alt="">
              <div class="team-details">
                <div class="team-inner">
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('frontend/img/blog/img1.jpg')}}" alt="">
                </a>                
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('frontend/img/blog/img2.jpg')}}" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <div class="date"><i class="lni-calendar"></i>10 April, 2018</div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('frontend/img/blog/img3.jpg') }}" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <div class="date"><i class="lni-calendar"></i>10 April, 2018</div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <div class="widget">
                ...
                <ul class="instagram-footer">
                  <li><a href="#"><img src="{{ asset('frontend/img/instagram/insta1.jpg')}}" alt=""></a></li>
                  <li><a href="#"><img src="{{ asset('frontend/img/instagram/insta2.jpg')}}" alt=""></a></li>
                  <li><a href="#"><img src="{{ asset('frontend/img/instagram/insta3.jpg')}}" alt=""></a></li>
                  <li><a href="#"><img src="{{ asset('frontend/img/instagram/insta4.jpg')}}" alt=""></a></li>
                  <li><a href="#"><img src="{{ asset('frontend/img/instagram/insta5.jpg')}}" alt=""></a></li>
                  <li><a href="#"><img src="{{ asset('frontend/img/instagram/insta6.jpg')}}" alt=""></a></li>
                </ul>
              </div>
            </div>
          </div>
