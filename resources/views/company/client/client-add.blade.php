            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            {{ Form::text('national_id', null, array('placeholder'=>'National_id', 'class' => 'form-control')) }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            {{ Form::text('work', null, array('placeholder'=>'Work', 'class' => 'form-control')) }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            {{ Form::text('comapany', null, array('placeholder'=>'Comapany', 'class' => 'form-control')) }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            {{ Form::text('bank', null, array('placeholder'=>'Bank', 'class' => 'form-control')) }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            {{ Form::text('iban', null, array('placeholder'=>'IBAN', 'class' => 'form-control')) }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            {{ Form::text('zipcode', null, array('placeholder'=>'Zip COde', 'class' => 'form-control')) }}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-1 control-label"></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5 pull-right">
                            <button class="btn btn-sm btn-primary submitbtn" type="submit">Add New Client</button>
                        </div>
                    </div>
