                        ...
                        @if($cmpMails)
                            @foreach($cmpMails as $emailList)
                                <tr class="unread">
                                    ...
                                    <td class="mail-ontact"><a href="{{ route('mail-detail') }}">{{ $emailList->name }}</a></td>
                                    <td class="mail-subject"><a href="{{ route('mail-detail') }}">{{ $emailList->subject ? $emailList->subject : strip_tags($emailList->message) }}</a></td>
                                    @if($emailList->file)
