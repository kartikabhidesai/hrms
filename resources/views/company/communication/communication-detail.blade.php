        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="mail-box-header">
                <div class="pull-right tooltip-demo">
                    <a href="{{url('')}}/company/compose?communication_id={{$cmpMailDetail->id}}&communication_table={{$cmpMailDetail->communication_table}}" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Reply"><i class="fa fa-reply"></i> Reply</a>
            ...
            <div class="mail-box">
                ...
                <div class="mail-body text-right tooltip-demo">
                        <a class="btn btn-sm btn-white" href="{{url('')}}/company/compose?communication_id={{$cmpMailDetail->id}}&communication_table={{$cmpMailDetail->communication_table}}"><i class="fa fa-reply"></i> Reply</a>
