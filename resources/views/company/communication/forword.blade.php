...
<!--                        <a class="btn btn-block btn-primary compose-mail" href="mail_compose.html">Compose Mail</a>-->
        ...
        <div class="col-lg-9 animated fadeInRight">
            ...
            {{ Form::open(array('method' => 'post', 'class' => 'form-horizontal', 'id' => 'forwardFrom')) }}  
                    ...
                    <div class="mail-body">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Subject:</label>
                                <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control subject" name="subject" value="{{$details->subject }}">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">File:</label>
                                <div class="col-sm-10">
                                    <!---->
                                    @if($details->file != NULL || $details->file != '')
                                    <input type="text" class="form-control file hidden" value="{{ $details->file }}" name="oldFile">
                                    <a href="{{ asset($details->file) }}" download><label class="control-label">View File</label></a>
                                    @else
                     ...
                     <div class="mail-text h-200">
                            <textarea rows="5" cols="125" name="summernote" class="summernote">{{ $details->message }}</textarea>
                          <div class="clearfix"></div>
                    </div>
