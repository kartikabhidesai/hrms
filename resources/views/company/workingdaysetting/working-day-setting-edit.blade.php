...
<div id="addNonWorkingDate" class="modal fade" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="" method="POST" class="form-horizontal" id="addNonWorkingDateForm">
                ...
                <div class="modal-footer">
                    <button id="submitbtn" class="btn btn-sm btn-primary m-l newDateModel submitbtn" type="submit">Submit</button>
