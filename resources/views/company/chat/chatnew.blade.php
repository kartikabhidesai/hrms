        ...
        <div class="col-lg-12">
            <div class="ibox chat-view">
                <div class="ibox-title">
                    ...
                    <span id="to_user_name" > {{ $reciverdetails[0]->name }} <span > 
                            </div>
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-md-9 ">
                                        ...
                                        <form method="POST">
                                            ...
                                            <div class="col-md-3" style="padding: 0px;">
                                                <a class="btn btn-primary btn-block send_chat" style="height: 54px;padding-top: 20px"><i class="fa fa-reply" ></i><span class="send_chatbtn">Send</span></a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-md-3">
