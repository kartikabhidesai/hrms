                        ...
                        <div class="col-md-9 ">
                            <div class="chat-discussion">
                                ...
                                <div class="chat-message left">
                                    <img class="message-avatar" src="{{ url('img/a1.jpg') }}" alt="" >
                                    <div class="message">
                                ...
                                <div class="chat-message right">
                                    <img class="message-avatar" src="{{ url('img/a4.jpg') }}" alt="" >
                                    <div class="message">
                                ...
                                <div class="chat-message right">
                                    <img class="message-avatar" src="{{ url('img/a2.jpg') }}" alt="" >
                                    <div class="message">
                                        <a class="message-author" href="#"> Michael Smith </a>
                                        <span class="message-date">  Fri Jan 25 2015 - 11:12:36 </span>
                                        <span class="message-content">
                                ...
                                <div class="chat-message left">
                                    <img class="message-avatar" src="{{ url('img/a5.jpg') }}" alt="" >
                                    <div class="message">
                                ...
                                <div class="chat-message right">
                                    <img class="message-avatar" src="{{ url('img/a6.jpg') }}" alt="" >
                                    <div class="message">
