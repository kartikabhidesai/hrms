                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group" id="data_2">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="expiry_date" id="expiry_date"  class="form-control expiry_date" placeholder="Expiry Date" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-12">
                            <div class="col-lg-8 col-lg-offset-2">
                                <button class="btn btn-sm btn-primary submitbtn" type="submit">Add Annoucement</button>
