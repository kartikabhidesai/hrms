                ...
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        ...
                        <ul class="folder-list m-b-md" style="padding: 0">
                            <li><a href="{{ url('admin/communication') }}"> <i class="fa fa-inbox "></i> Inbox <span class="label label-warning pull-right">16</span> </a></li>
        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="mail-box-header">
                <div class="pull-right tooltip-demo">
                    <a href="{{url('')}}/admin/compose?communication_id={{$cmpMailDetail->id}}&communication_table={{$cmpMailDetail->communication_table}}" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Reply"><i class="fa fa-reply"></i> Reply</a>
            ...
            <div class="mail-box">
                ...
                <div class="mail-body text-right tooltip-demo">
                        <a class="btn btn-sm btn-white" href="{{url('')}}/admin/compose?communication_id={{$cmpMailDetail->id}}&communication_table={{$cmpMailDetail->communication_table}}"><i class="fa fa-reply"></i> Reply</a>
