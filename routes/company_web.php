...
//    task-list
    ...
    Route::match(['get', 'post'], 'task-comments/{id}', ['as' => 'task-comments', 'uses' => 'Company\TaskController@taskComments']);
    Route::match(['get', 'post'], 'edit-task/{id}', ['as' => 'edit-task', 'uses' => 'Company\TaskController@editTask']);
